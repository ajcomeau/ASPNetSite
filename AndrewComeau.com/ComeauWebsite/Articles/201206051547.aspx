<%@ Page Title="Looking for Square Pegs - Comeau Software Solutions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="201206051547.aspx.cs" Inherits="ComeauWebsite.Articles._201206051547"
MetaDescription="Designing algorithms to solve programming challenges. A step-by-step look at how solutions are turned into code. Features C# code and an online demo." 
MetaKeywords="C#, algorithm, .NET, visual studio, programming, software, development, Ocala"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    just sitting down and typing code, it's a<span class="style4">bout designing solutions to 
    everyday problems using technical knowledge gained over years of training 
    and experience. Larger projects can include a series of challenges to sol</span>ve, 
    ...
    <p>
    Since it is a self-contained function, my next thought is about <em>code reuse</em>. 
    ...
    it as <i>arguments</i> like the ones shown in parentheses in the example below. </p>
    
    <p class="code">
        protected string QuoteBoxText(string QuoteText, string Author)</p>
    
    <p>
        This is actually the declaration for the function that formats the random quotes 
        that you see at the top of each page here on the site. The function will use these values during its 
    calculations, taking the text of the quote and the author&#39;s name and creating the 
        HTML code used to display them. In the case of the function we&#39;re working on now, 
        it will need to accept a list of text 
    ...
    delimited string (in the above example - 1234 and 1235). The code that calls this function can then use that 
    ...
    &quot;<font face="Courier New">1234,1234,1234,1235,1234&quot;</font> to:</p>
    ...
    <p>
    So now I have 
        the array of values shown above to check and an empty return list. 
    ...
    <p class=carrayIndex = 0<br>
    <br>
        <strong>foreach</strong> (string inputValue in inputList)<br>
    {<br>
&nbsp;&nbsp;&nbsp; match = false;<br>
        <br />
&nbsp;&nbsp;&nbsp; if (arrayIndex &gt; 0)<br>
&nbsp;&nbsp;&nbsp; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>foreach</strong> (String 
...
&nbsp;&nbsp;&nbsp; arrayIndex++<br>
   ...
   That's right. With some extra research, we've gone from over 15 lines 
    of code (including the variable declarations I didn't show) down to <em>three</em>, 
