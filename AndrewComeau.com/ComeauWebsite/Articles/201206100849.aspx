<%@ Page Title="Getting in Sync: A Demonstration of Recursive Programming - Comeau Software Solutions" MetaDescription="A demonstration of recursive programming in .NET. Comparing copies of a file collection to find discrepancies." MetaKeywords="recursion, .NET, Visual Basic, programming, recursive programming, demonstration, download, Ocala" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="201206100849.aspx.cs" Inherits="ComeauWebsite.Articles._201206100849" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    </span><span class="articlesub">Using recursive programming to compare directories in VB.NET</span></strong>&nbsp;
        <h4>Introduction</h4>
    ...
    subroutine reaches the subfolder for ELO.&nbsp;The routine then calls <i>itself</i> to examine <span class="dirpath">F:\My 
...
<span class="style2">        'If there are files, process each one.
            ...
            For Each fileName As String In FileIO.FileSystem.GetFiles(subDirectory)
                ...
                <span class="style2">'If corresponding file does not exist, add the necessary information 
			to the output field.
</span>                If Not FileIO.FileSystem.FileExists(comparisonFile) Then
                    fileNameOnly = FileIO.FileSystem.GetName(fileName)
                    altDirectory = comparisonFile.Substring(0, Len(comparisonFile) - 
			Len(fileNameOnly))
...
<strong>                </strong><span class="style2"><strong>'Recursively check subdirectories if they exist.
                ...
                Else
                    <span class="style2">'If the corresponding directory does not exist, add the necessary 
			information to the output field.
