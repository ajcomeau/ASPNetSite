<%@ Page Title="Article Search - AndrewComeau.com" MetaDescription="Site search page for AndrewComeau.com" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="ComeauWebsite.Search" %>
    ...
    <table class="style2">
        ...
        <tr>
            <td class="style3" align="center" colspan="3">
                Use the fields below to search for an article on AndrewComeau.com.</td>
        </tr>
        <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="pnlGoogle" runat="server">
        ...
        <br />
        To search the full text of articles on AndrewComeau.com, try the Google custom 
