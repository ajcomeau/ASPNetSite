<%@ Page Title="Sometimes, it's better to roll your own ... - AndrewComeau.com" MetaDescription="Using interface components vs. custom components in Visual Studio." MetaKeywords="programming, object oriented, VB.NET, download" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="201206100958.aspx.cs" Inherits="ComeauWebsite.Articles._201206100958" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h5>
        Previously featured on Drewslair.com.
        Revised June 2012.</h5>
    <p>
        After I got serious about sharpening my skills with <a target="_blank" href="http://www.asp.net/">ASP.NET</a>,
        Microsoft's web building
        technology that blends HTML with .NET code to deliver dynamic web pages, it didn't
        take me long to think of ways that I could use it with this site. My other site, Drewslair.com, has gone
        ...
        possibility of dropping them in the future. This prompted me to learn a lot more about 
        ...
        and other web technologies so I could keep the same look and feel.&nbsp;
    </p>
    <p>
        For a time, I switched the site over to ASP.NET which meant moving away from FrontPage entirely
        and redoing the site in <a target="_blank" href="http://www.microsoft.com/visualstudio/en-us/default.mspx">
    ...
    <p>
        ...
        class
        to manage the connection to the database and accept <a href="../access/beginners/sqlbasics.shtml">
            SQL commands</a> to return the data
    ...
    <p>
        ...
        and one for AndrewComeau.com (.net, .org ...).&nbsp; So, during 2010, I split AndrewComeau.com 
    ...
    <p>
        ...
        AndrewComeau.com was reborn as the site you&#39;re enjoying right now!</p>
    <p>
